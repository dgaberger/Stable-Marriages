...
def stable_marriage_alg(pop, nruns, printval = True):
  for r in range(nruns):    #iterate for nruns
    ...
    while not allPaired:
      ...
      for i in women:     #rejecting proposals
        ...
        if i.reject == True:
          i.r_count += 1        #after all rejections instruct rejected to move down list
    ...
    def printALL(w, m):
      print("Women:")
      for i in w:
        print(i.ident, i.pref, i.r_count)
      print("\nMen:")
      for i in m:
        print(i.ident, i.pref, i.tent) 
    
    if printval == True:  
      print("The algorithm took %s days for iteration %s" % (day, r + 1))
      printALL(women, men)
  
stable_marriage_alg(10,10)
